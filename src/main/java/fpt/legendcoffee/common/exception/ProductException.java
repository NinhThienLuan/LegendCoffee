...
public class ProductException {
    ...
    public String handleMaxUploadSizeExceeded(MaxUploadSizeExceededException ex, jakarta.servlet.http.HttpServletRequest request) {
    ...
    public String handleValidationException(IllegalArgumentException ex, jakarta.servlet.http.HttpServletRequest request) {
        org.springframework.web.servlet.FlashMap flashMap = org.springframework.web.servlet.support.RequestContextUtils.getOutputFlashMap(request);
        if (flashMap != null) {
